...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    MO(2)          , KC_LALT , KC_LGUI ,                     KC_SPC   ,                      KC_RGUI , MO(1)   , KC_RALT , KC_LEFT , KC_DOWN , KC_RGHT
    ),
  [1] = LAYOUT(
  ...
  [2] = LAYOUT(
    ...
    MO(1)         , _______  , _______ , _______ , _______ , _______  , _______  , KC_LEFT , KC_DOWN , KC_UP   , KC_RIGHT , _______ , _______ ,
    _______       , _______  , _______ , _______ , _______ , _______  , _______  , _______ , _______ , _______ , _______ , _______ , RGB_SAI ,
    MO(2)         , _______  , _______ ,                     _______  ,                      _______ , MO(2)   , MO(1)   , RGB_HUD , RGB_SAD , RGB_HUI
    )
};
